...
//-TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  List<Story> _story = [
    Story('You are riding a motorbike trafic signal in front of you turns red.', 'Break the signal and rush','Wait for the signal to turn green'),
    Story('You move on and you see nother signal in front of you is yeloow and its going to be red', 'Speed up your bike ', 'Drive patientently'),
    Story('You rushed and trafic police is behind you signaling to stop your bike', 'You speed away and tries to run', 'You stops the bike quickly'),
    Story('Signal turns red and trafic police officer passes you smile for following traffic rules', 'Well Played !!!\nPlay Again', 'Restart'),
    Story('You are fined for over speeding', 'Drive Slowly \n Play Again', 'Restart'),
    Story('A car hits you and you are crashed', 'Drive Carefully and obey Trafic Rules\n Play Again', 'Restart'),
  ];
